...
RUN apt-get -y install libcap-dev python3-libcamera libxslt-dev libxml2-dev build-essential libssl-dev libffi-dev python3-dev  zlib1g-dev liblapack3 libatlas-base-dev
